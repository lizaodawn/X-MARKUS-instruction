 ...
 * 0.23 (Aug 23 2024) add window.DocuSkyHost check to allow setting obj.urlHostPath externally (say DocuSky.connectivity.js)
 * 0.23a (2024-12-27) alter the path for "loading-circle.gif" for Xmarkus
 *
 * @copyright
...
var WithCredentials = false;              // 2022-02-11: 若放到 server 上，可能需設為 false（避免瀏覽器不接受 Access-Control-Allow-Origin:* -- 但瀏覽器在登入時會顯示「不安全」訊息）
...
var ClsDocuskyManageDbListSimpleUI = function(param) {     // constructor
   ...
   var init = function() {
      ...
      var s = "<div id='" + loadingContainerId + "' style='position:absolute; border:3px grey solid; border-radius:6px; background-color:white; z-index: 1003;'>" +
              ...
              "<img src='./images/loading-circle.gif' width='140' border='0'/>" +             // 2024-12-30
              "</div>" +
