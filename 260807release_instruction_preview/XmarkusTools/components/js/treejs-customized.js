...
Tree.prototype.bindEvent = function (ele) {
  ...
  ele.addEventListener('click', function (e) {
    ...
    } else if (target.nodeName === 'SPAN' && target.classList.contains('treejs-switcher')) {     // checkbox 前的三角形
...
Tree.prototype.onItemClick = function (id) {
  ...
  console.log('item clicked: ' + id);             // 2025-02-15
};

Tree.prototype.setValue = function (value) {      // toggle status?
...
Tree.prototype.selectAll = function() {
   for (let id in this.leafNodesById) {
      if (!this.nodesById[id].status || this.nodesById[id].status === 0) this.setValue(id);
   }
   this.updateLiElements();
}

// 2025-02-16: (Tu)
Tree.prototype.selectInverse = function() {
   for (let id in this.leafNodesById) this.setValue(id);
   this.updateLiElements();
}
...
// module
// 2025-02-12: 在 .treejs-checkbox 加上 margin-right:5px; （不知該怎麼調整框線顏色，outline:1px solid #1e5180; 會加上過大的框...）
//             為了方便，將原先的 :before (CSS2) 改為 ::before (CSS3)，:after 改為 ::after
//             到 github 找到原始碼 index.less，發現 @greyborder: #d9d9d9; 因此將 #d9d9d9; 通通改為 #d7d7d7; 以將 checkbox border 改得深色些
// 2025-02-15 => 更動總結：文字 #3f3f3f，checkbox 框 #d7d7d7，.treejs-checkbox::before 加上 opacity:0.5
// 2025-02-16 => line-height:165%; font-size:14px; (原先的 font-size 暫時不用，改為 xfont-size) 
exports.push([module.i, ".treejs {\n font-size:14px; line-height:165%; -webkit-box-sizing: border-box;\n          box-sizing: border-box;\n  xfont-size: 16px; color:#3f3f3f;\n}\n.treejs *::after,\n.treejs *::before {\n  -webkit-box-sizing: border-box;\n          box-sizing: border-box;\n}\n.treejs > .treejs-node {\n  padding-left: 0;\n}\n.treejs .treejs-nodes {\n  list-style: none;\n  padding-left: 20px;\n  overflow: hidden;\n  -webkit-transition: height 150ms ease-out, opacity 150ms ease-out;\n  -o-transition: height 150ms ease-out, opacity 150ms ease-out;\n  transition: height 150ms ease-out, opacity 150ms ease-out;\n}\n.treejs .treejs-node {\n  cursor: pointer;\n  overflow: hidden;\n}\n.treejs .treejs-node.treejs-placeholder {\n  padding-left: 20px;\n}\n.treejs .treejs-switcher {\n  display: inline-block;\n  vertical-align: middle;\n  width: 20px;\n  height: 20px;\n  cursor: pointer;\n  position: relative;\n  -webkit-transition: -webkit-transform 150ms ease-out;\n  transition: -webkit-transform 150ms ease-out;\n  -o-transition: transform 150ms ease-out;\n  transition: transform 150ms ease-out;\n  transition: transform 150ms ease-out, -webkit-transform 150ms ease-out;\n}\n.treejs .treejs-switcher::before {\n  position: absolute;\n  top: 8px;\n  left: 6px;\n  display: block;\n  content: ' ';\n  border: 4px solid transparent;\n  border-top: 4px solid rgba(0, 0, 0, 0.4);\n  -webkit-transition: border-color 150ms;\n  -o-transition: border-color 150ms;\n  transition: border-color 150ms;\n}\n.treejs .treejs-switcher:hover::before {\n  border-top: 4px solid rgba(0, 0, 0, 0.65);\n}\n.treejs .treejs-node__close > .treejs-switcher {\n  -webkit-transform: rotate(-90deg);\n      -ms-transform: rotate(-90deg);\n          transform: rotate(-90deg);\n}\n.treejs .treejs-node__close > .treejs-nodes {\n  height: 0;\n}\n.treejs .treejs-checkbox {\n  display: inline-block;\n  vertical-align: middle;\n  width: 20px;\n  height: 20px;\n  cursor: pointer;\n  position: relative; margin-right:5px; \n}\n.treejs .treejs-checkbox::before {\n  -webkit-transition: all 0.3s;\n  -o-transition: all 0.3s;\n  transition: all 0.3s;\n  cursor: pointer;\n  position: absolute;\n  top: 2px;\n  content: ' ';\n  display: block;\n  width: 16px;\n  height: 16px;\n  border: 1px solid #b7b7b7;\n  border-radius: 2px;\n}\n.treejs .treejs-checkbox:hover::before {\n  -webkit-box-shadow: 0 0 2px 1px #1890ff;\n          box-shadow: 0 0 2px 1px #1890ff;\n}\n.treejs .treejs-node__checked > .treejs-checkbox::before {\n  background-color: #1890ff;\n  border-color: #1890ff;\n}\n.treejs .treejs-node__checked > .treejs-checkbox::after {\n  position: absolute;\n  content: ' ';\n  display: block;\n  top: 4px;\n  left: 5px;\n  width: 5px;\n  height: 9px;\n  border: 2px solid #fff;\n  border-top: none;\n  border-left: none;\n  -webkit-transform: rotate(45deg);\n      -ms-transform: rotate(45deg);\n          transform: rotate(45deg);\n}\n.treejs .treejs-node__halfchecked > .treejs-checkbox::before {\n background-color: #1890ff;\n  opacity:0.5; border-color: #1890ff;\n}\n.treejs .treejs-node__halfchecked > .treejs-checkbox::after {\n  position: absolute;\n  content: ' ';\n  display: block;\n  top: 9px;\n  left: 3px;\n  width: 10px;\n  height: 2px;\n  background-color: #fff;\n}\n.treejs .treejs-node__disabled {\n  cursor: not-allowed;\n  color: rgba(0, 0, 0, 0.25);\n}\n.treejs .treejs-node__disabled .treejs-checkbox {\n  cursor: not-allowed;\n}\n.treejs .treejs-node__disabled .treejs-checkbox::before {\n  cursor: not-allowed;\n  border-color: #b7b7b7 !important;\n  background-color: #f5f5f5 !important;\n}\n.treejs .treejs-node__disabled .treejs-checkbox:hover::before {\n  -webkit-box-shadow: none !important;\n          box-shadow: none !important;\n}\n.treejs .treejs-node__disabled .treejs-node__checked > .treejs-checkbox::after {\n  border-color: #b7b7b7;\n}\n.treejs .treejs-node__disabled .treejs-node__halfchecked > .treejs-checkbox::after {\n  background-color: #b7b7b7;\n}\n.treejs .treejs-node__disabled.treejs-node__checked > .treejs-checkbox::after {\n  border-color: #b7b7b7;\n}\n.treejs .treejs-node__disabled.treejs-node__halfchecked > .treejs-checkbox::after {\n  background-color: #b7b7b7;\n}\n.treejs .treejs-label {\n  vertical-align: middle; \n}\n", ""]);
...
//# -- disable map -- sourceMappingURL=tree.js.map